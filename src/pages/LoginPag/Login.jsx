...
import { IconBrightnessUp, IconEye, IconEyeOff, IconMoonFilled } from "@tabler/icons-react";
  ...
  return (
    <main className=" overflow-x-hidden h-screen grid place-content-center dark:bg-DarkFondo  dark:text-white relative">
      <div className="absolute top-5 right-5">
        <button onClick={HandleTheme}> { ThemeActual === "light" ? <IconMoonFilled/> :<IconBrightnessUp/>  } </button>
      </div>
